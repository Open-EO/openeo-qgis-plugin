...
class OpenEODialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def job_info(self, row):
        ...
        self.dlg = JobDetailDialog(iface=self.iface, job=job)
    ...
    def init_services(self):
        ...
        self.servicesTableWidget.setColumnCount(4)
